...
class Goods extends Api
{
    ...
    private $goodsAllowedFields = [
        ...
        , 'downtime', 'sort', 'is_hot', 'is_recommend', 'ctime', 'utime', 'params','package'
    ];
    //货品允许字段
...
//        }
    ...
    public function getPackage()
    {
        ...
        $data = Db::name('goods')
            ->field('id,image_id,name,price,brief,package')
            ->where('package=2 or package=3')
            ->select()
            ->toArray();
        if(sizeof($data) == 0){
